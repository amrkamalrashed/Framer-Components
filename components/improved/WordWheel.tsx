// WordWheel.tsx (Improved)
// Vertical rotating word ticker with center-focus effect
// Version: 1.1.0
//
// Changes from original:
// [CHANGE 1] Added style?: React.CSSProperties to Props interface
// [CHANGE 2] Destructure style from props in the component function
// [CHANGE 3] Spread ...style on both root container divs (static and animated)
// [CHANGE 4] Added WordWheel.displayName = "Word Wheel"
// [CHANGE 5] Added prefers-reduced-motion support via useState+useEffect
// [CHANGE 6] Added @framerIntrinsicWidth 300 and @framerIntrinsicHeight 400 to JSDoc
 ...
 */
// [CHANGE 6] Added @framerIntrinsicWidth 300 and @framerIntrinsicHeight 400 above
export default function WordWheel({
    ...
    // [CHANGE 5] Timer — only runs when in view AND reduced motion is NOT preferred
    useEffect(() => {
        if (isStatic || count === 0 || !inView || prefersReducedMotion) return
        const id = setInterval(tick, interval)
        return () => clearInterval(id)
    }, [interval, count, isStatic, tick, inView, prefersReducedMotion])
    ...
    if (isStatic) {
        ...
        return (
            // [CHANGE 3] Spread ...style on the static root container div
    ...
    return (
        // [CHANGE 3] Spread ...style on the animated root container div
        <div
            ref={containerRef}
...
// [CHANGE 4] Added displayName for Framer panel clarity
WordWheel.displayName = "Word Wheel"
