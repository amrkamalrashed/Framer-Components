// WachttijdMeter.tsx
// Wachttijd (waiting time) meter component with milestone bars and tick marks.
// Version: 1.1.0
//
// Changes from original:
// [CHANGE 1] Added displayName for Framer panel clarity
// [CHANGE 2] Guarded ResizeObserver with canvas check; uses default width (600) on canvas
// [CHANGE 3] Added @framerIntrinsicWidth 600 and @framerIntrinsicHeight 200 to JSDoc
// [CHANGE 4] Added role="list" to root container and role="listitem" to each milestone
 ...
 */
// [CHANGE 3] Added @framerIntrinsicWidth 600 and @framerIntrinsicHeight 200 above
export default function WachttijdMeter({
    ...
    // [CHANGE 2] Use RenderTarget to detect canvas mode
    const isCanvas = RenderTarget.current() === "canvas"
    const [containerWidth, setContainerWidth] = useState(isCanvas ? 600 : 0) // [CHANGE 2] default 600 on canvas

    useEffect(() => {
        // [CHANGE 2] Skip ResizeObserver on canvas to avoid excessive firing
        if (isCanvas) return
    ...
    if (isVertical) {
        return (
            <div
                ref={containerRef}
                role="list" // [CHANGE 4] accessibility: list role
                style={{
                    display: "flex",
            ...
            >
                {milestones.map((m, i) => (
                    <div key={i} role="listitem"> {/* [CHANGE 4] accessibility: listitem role */}
                        <div
                            style={{
                                display: "flex",
                                alignItems: "center",
        ...
        >
            ...
            {containerWidth > 0 && (
                ...
                >
                    {/* Left — align left */}
                    <div
                        role="listitem" // [CHANGE 4] accessibility: listitem role
                        style={{
                            display: "flex",
                            flexDirection: "column",
                            gap: textGap,
...
// [CHANGE 1] Added displayName for Framer panel clarity
WachttijdMeter.displayName = "Wachttijd Meter"
