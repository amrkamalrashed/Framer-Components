...
// [CHANGE 2] Guarded IntersectionObserver with canvas check — skips observer on canvas and sets isInView(true) immediately
// [CHANGE 3] Moved prefersReducedMotion into useState+useEffect pattern with live media query listener
// [CHANGE 4] Added @framerIntrinsicWidth 200 and @framerIntrinsicHeight 40 to JSDoc
// [CHANGE 5] Changed font prop type from `any` to `Record<string, any> | undefined`
// [CHANGE 6] Changed cursor span marginLeft/marginRight to marginInlineStart/marginInlineEnd for RTL support
...
import { addPropertyControls, ControlType, RenderTarget } from "framer" // [CHANGE 2] Added RenderTarget import
...
interface TypewriterEffectProps {
    ...
    cursorWidth: number
    cursorHeight: number
    font?: Record<string, any> // [CHANGE 5] Typed properly instead of `any`
    textColor: string
    style?: CSSProperties
}
 ...
 */
// [CHANGE 4] Added @framerIntrinsicWidth 200 and @framerIntrinsicHeight 40
export default function TypewriterEffect(props: TypewriterEffectProps) {
    ...
    // [CHANGE 2] Canvas detection for guarding IntersectionObserver
    ...
    // [CHANGE 3] Moved prefersReducedMotion into useState+useEffect with live listener
    ...
    // [CHANGE 2] Intersection Observer - Guarded with canvas check
    useEffect(() => {
        if (!startOnView || isCanvas) {
            setIsInView(true) // Always in view if feature disabled or on canvas
            return
        }
    ...
    }, [startOnView, hasStarted, isCanvas])
        ...
        >
            ...
            <span
                ...
                style={{
                    ...
                    marginInlineStart: 2, // [CHANGE 6] RTL-safe logical property
                    marginInlineEnd: 2,   // [CHANGE 6] RTL-safe logical property
...
// [CHANGE 1] Added displayName for Framer panel clarity
TypewriterEffect.displayName = "Typewriter Effect"
